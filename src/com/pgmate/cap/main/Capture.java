...
public class Capture {
	...
	public void addPartToChargeSettleFirm() {
	...
	public void capture(SharedMap<String,Object> trxPayMap) {
		...
		boolean isRentApp = "사용".equals(mchtSvcMap.getString("rent")) && trxRentMap != null && !trxRentMap.isNullOrSpace("rentId");
...
//				warningList.add(trxId);
		...
		if (orgFeeMap.size() > 0) {
			...
			if (!mchtMngMap.getString("diffType").equals("일반") && trxDAO.isDiffSettleVanId(trxPayMap.getString("vanId")) && mchtMngMap.getString("memDiffSettleStatus").equals("사용")) {
...
//					(capDtlMap.getString("van").startsWith("WELCOME") && (trxPayMap.isEquals("vanId", "wpbukok302") || trxPayMap.isEquals("vanId", "wpbukok501") || trxPayMap.isEquals("vanId", "wpbukok201") || trxPayMap.isEquals("vanId", "wel000937m")|| trxPayMap.isEquals("vanId", "wel000936m")|| trxPayMap.isEquals("vanId", "wel000935m")))) {
	...
	public String calcTransferDay(String transferDayStr) {
		int transferDay = Integer.parseInt(transferDayStr);
...
//		chargeSettleFirmMap.put("balance"	, trxDAO.getMchtBalance(trxCapMap.getString("mchtId")).getLong("balance")+Math.abs(capDtlMap.getLong("stlAmount")));
	...
	public void refund(SharedMap<String,Object> trxRfdMap){
		...
		if(orgFeeMap.size() >0){
			...
			if (!mchtMngMap.getString("diffType").equals("일반") && trxDAO.isDiffSettleVanId(trxRfdMap.getString("vanId")) && mchtMngMap.getString("memDiffSettleStatus").equals("사용")) {
